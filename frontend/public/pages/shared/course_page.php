              ...
              <div class="w-full overflow-auto">
                ...
                ?>
                    <div class="container">
                      <div class="options">
                        <div class="option">
                          <a href="../teacher/add_assessment.php?userid=<?php echo $_SESSION["user_id"]; ?>&courseid=<?php echo $courseID; ?>"><i class="fas fa-plus"></i> Add Assessment</a>
                        </div>
                        <div class="option">
                          <a href="../teacher/add_course.php?userid=<?php echo $_SESSION["user_id"]; ?>&courseid=<?php echo $courseID; ?>&currentfile=../shared/course_page.php"><i class="fas fa-edit"></i> Edit</a>
                        </div>
                        <form method="POST" class="options">
                          <div class="option">
                            <?php if ($course_info_row['user_id'] === $_SESSION['user_id'] && $course_info_row['course_id'] === $courseID && $course_info_row['course_status'] === '1') { ?>
                              ...
                              <button type=" submit" id="deactive-btn" name="deactive_submitbtn"><i class="fas fa-eye-slash"></i> Deactivate</button>
                            <?php } else { ?>
                              <button type="submit" id="active-btn" name="active_submitbtn"><i class="fas fa-eye"></i> Activate</button>
                            <?php } ?>

                          </div>
                          <div class="option">
                            <button type="submit" id="delete-btn" name="delete_submitbtn"><i class="fas fa-trash"></i> Delete</button>
                          </div>
                        </form>
                      </div>
                ...
                <div id="search-results" class="result-container">
                  ...
                  ?>
                        <a class="view-ass" href="../shared/view_assessment.php?ass_id=<?php echo $data["assessment_id"]; ?>&courseid=<?php echo $courseID; ?>">
                    ...
                    if ($course_info_row["user_id"] == $_SESSION["user_id"]) {
                      ...
                      <div class="container">
                        ...
                        <div class="publish-container">
                          <button onclick="location.href='../teacher/add_assessment.php?userid=<?php echo $_SESSION['user_id']; ?>&courseid=<?php echo $courseID; ?>'" class="published post-btn">Post Assesment Now</button>
                        </div>
                      </div>
                    <?php
                    } else {
